...
class WP_Data_Access_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_register_style(
            'wpda_jqueryui_theme_structure',
            plugins_url( '../assets/css/jquery-ui.structure.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        ...
        wp_register_style(
            'wpda_jqueryui_theme',
            "https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/themes/{$jquery_ui_styles}/jquery-ui.min.css",
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        // Register jQuery Semantic UI
        wp_register_style(
            'wpda_semantic_ui',
            plugins_url( '../assets/css/semantic.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        // Register jQuery Foundation
        wp_register_style(
            'wpda_foundation_ui',
            plugins_url( '../assets/css/foundation.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        // Register jQuery Bootstrap3
        wp_register_style(
            'wpda_bootstrap_ui',
        ...
        // Register jQuery Bootstrap4
        wp_register_style(
            'wpda_bootstrap4_ui',
            plugins_url( '../assets/css/bootstrap4.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        ...
        wp_register_style(
            'jquery_datatables_jqueryui',
            plugins_url( '../assets/css/dataTables.jqueryui.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_semanticui',
            plugins_url( '../assets/css/dataTables.semanticui.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_foundation',
            plugins_url( '../assets/css/dataTables.foundation.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
        ...
        wp_register_style(
            'jquery_datatables_bootstrap4',
            plugins_url( '../assets/css/dataTables.bootstrap4.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        ...
        wp_register_style(
            'jquery_datatables_responsive_jqueryui',
            plugins_url( '../assets/css/responsive.jqueryui.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_responsive_semanticui',
            plugins_url( '../assets/css/responsive.semanticui.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_responsive_foundation',
            plugins_url( '../assets/css/responsive.foundation.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_responsive_bootstrap',
            plugins_url( '../assets/css/responsive.bootstrap.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_style(
            'jquery_datatables_responsive_bootstrap4',
            plugins_url( '../assets/css/responsive.bootstrap4.min.css', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        ...
        // According to the plugin guideliness it is allowed to include external fonts:
        ...
        wp_register_style( 'wpda_fontawesome_icons', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/fontawesome.min.css', [] );
        wp_register_style( 'wpda_fontawesome_icons_solid', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/solid.min.css', [] );
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_register_script(
            'jquery_datatables_jqueryui',
            plugins_url( '../assets/js/dataTables.jqueryui.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_script(
            'jquery_datatables_semanticui',
            plugins_url( '../assets/js/dataTables.semanticui.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_script(
            'jquery_datatables_foundation',
            plugins_url( '../assets/js/dataTables.foundation.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_script(
            'jquery_datatables_bootstrap',
            plugins_url( '../assets/js/dataTables.bootstrap.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        wp_register_script(
            'jquery_datatables_bootstrap4',
            plugins_url( '../assets/js/dataTables.bootstrap4.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
        // Register JQuery DataTables Responsive
        ...
        wp_register_script(
            'jquery_datatables_responsive_jqueryui',
            plugins_url( '../assets/js/responsive.jqueryui.min.js', __FILE__ ),
            [],
            WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
        );
