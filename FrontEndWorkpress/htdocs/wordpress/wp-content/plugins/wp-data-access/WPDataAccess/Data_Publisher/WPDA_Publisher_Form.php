...
class WPDA_Publisher_Form extends WPDA_Simple_Form
{
    ...
    public function prepare_items( $set_back_form_values = false )
    {
        ...
        foreach ( $this->form_items as $form_item ) {
            ...
            if ( 'pub_responsive_popup_title' === $form_item->get_item_name() || 'pub_responsive_cols' === $form_item->get_item_name() || 'pub_responsive_type' === $form_item->get_item_name() || 'pub_responsive_modal_hyperlinks' === $form_item->get_item_name() || 'pub_responsive_icon' === $form_item->get_item_name() || 'pub_default_where' === $form_item->get_item_name() || 'pub_default_orderby' === $form_item->get_item_name() || 'pub_table_options_advanced' === $form_item->get_item_name() || 'pub_show_advanced_settings' === $form_item->get_item_name() ) {
    ...
    public function show( $allow_save = true, $add_param = '' )
    {
        ...
        ?>)");
				...
				jQuery(function () {
					...
					jQuery("#pub_advanced").html(pub_show_advanced_settings_copy);
        ...
        ?>?page=wpdataaccess&tab=datapublisher" target="_blank"><span title="Yes: use premium styling settings below\nNo: use default plugin styling\n\nNOTE\nSet global publication style to Default and disable Compact mode (click to check)" class="material-icons pointer wpda_tooltip">help</span></a>');
