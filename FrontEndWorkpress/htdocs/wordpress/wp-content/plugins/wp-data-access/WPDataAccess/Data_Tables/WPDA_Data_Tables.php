...
class WPDA_Data_Tables
{
    ...
    )
    {
        ...
        if ( !$is_embedded ) {
            ...
            $wpnonce = wp_create_nonce( $nonce_seed );
        } else {
            // Plugin string based nonce to secure embedding
            $wpnonce = WPDA::wpda_create_sonce( $nonce_seed );
        }
