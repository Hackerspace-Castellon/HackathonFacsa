...
class WPDA_Dashboard
{
        ...
        ?>
			<div id="wpda-dashboard-toolbar" class="wpda-dashboard-toolbar">
				<div style="white-space:nowrap">
					<i class="material-icons wpda_tooltip" style="font-size:28px;vertical-align:sub" title="Add dashboard" onclick="manageTabs()">tab</i>
					<span class="wpda-horizontal-separator"></span>
					<?php 
    ...
    protected function toolbar_designer()
    {
        ...
        ?>">
			...
			<div id="wpda-dashboard-toolbar" class="wpda-dashboard-toolbar">
				<div>
					<i id="wpda_toolbar_icon_add_designer" class="fas fa-plus-circle wpda_tooltip" title="Create new design" onclick="jQuery('#wpda_new_design').submit()"></i>
